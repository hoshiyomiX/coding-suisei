...
[![Version](https://img.shields.io/badge/version-5.5.0-blue.svg)](skill/stellar-frameworks/CHANGELOG.md)
...
Invoke: `Skill(command="stellar-frameworks")` — look for `☄️ STELLAR · v5.5.0 · ACTIVE`.
