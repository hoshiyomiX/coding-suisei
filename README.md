...
[![Version](https://img.shields.io/badge/version-5.4.6-blue.svg)](skill/stellar-frameworks/CHANGELOG.md)
...
Invoke: `Skill(command="stellar-frameworks")` — look for `☄️ STELLAR · v5.4.6 · ACTIVE`.
...
| Version | Summary |
|---------|---------|
| [**v5.4.6**](skill/stellar-frameworks/CHANGELOG.md) | Bugfix: popup preview now launches immediately on fresh install (not deferred to next session). PID file + port guard prevent duplicate launches. |
